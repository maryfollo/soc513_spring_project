...
```{r model_attempt, echo=FALSE, message=FALSE, error=FALSE, fig.cap="Table 1: Regression Model Predicting Voting by Attention Paid to the Media across Age 2016"}
